...
"")
        ...
        self.SWON_DREFS_TABLE.setColumnCount(5)
        ...
        self.gridLayout.addLayout(self.gridLayout_3, 8, 0, 1, 5)
        ...
        self.SWOFF_DREFS_TABLE.setColumnCount(5)
        ...
        self.gridLayout.addLayout(self.gridLayout_4, 10, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.SWEDIT_nameLineEdit, 3, 1, 1, 3)
        ...
        self.gridLayout.addWidget(self.SWEDIT_IDlineEdit, 4, 1, 1, 3)
        ...
        self.testSWON_CMDS_button.clicked.connect(switchEditForm.testSwitchOnCommands)
        self.testSWOFF_CMDS_button.clicked.connect(switchEditForm.testSwitchOffCommands)
        self.SW_PIN_comboBox.currentTextChanged['QString'].connect(switchEditForm.updateSwitchPin)
        ...
        self.SWON_DREFS_TABLE.itemChanged['QTableWidgetItem*'].connect(switchEditForm.updateSwitchXMLdata)
        self.SWOFF_DREFS_TABLE.itemChanged['QTableWidgetItem*'].connect(switchEditForm.updateSwitchXMLdata)
        self.testSWOFF_DREFS_button.clicked.connect(switchEditForm.testSwitchOffDatarefs)
        self.testSWON_DREFS_button.clicked.connect(switchEditForm.testSwitchOnDatarefs)
