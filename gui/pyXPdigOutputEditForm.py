...
import gui.digOutputEditForm as digOutputEditForm
...
class pyXPdigOutputEditForm(QtWidgets.QWidget, digOutputEditForm.Ui_digOutputEditForm):
	...
	def updatePin(self):
		logging.debug("dig output pin updated")
