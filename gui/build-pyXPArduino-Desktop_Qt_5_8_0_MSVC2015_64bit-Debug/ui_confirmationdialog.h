...
public:
    ...
    {
        deleteConfirmationDialog->setWindowTitle(QApplication::translate("deleteConfirmationDialog", "Delete Item", Q_NULLPTR));
        label->setText(QString());
        label_2->setText(QApplication::translate("deleteConfirmationDialog", "Are you sure you want to delete the item?", Q_NULLPTR));
    } // retranslateUi
