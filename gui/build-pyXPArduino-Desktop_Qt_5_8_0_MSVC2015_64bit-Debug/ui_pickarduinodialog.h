...
public:
    ...
    {
        AddArduinoDialog->setWindowTitle(QApplication::translate("AddArduinoDialog", "Add Arduino", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = arduinoTableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("AddArduinoDialog", "Select", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = arduinoTableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("AddArduinoDialog", "Port", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = arduinoTableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("AddArduinoDialog", "Name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = arduinoTableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("AddArduinoDialog", "Description", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = arduinoTableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("AddArduinoDialog", "Serial Number", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem5 = arduinoTableWidget->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("AddArduinoDialog", "Manufacturer", Q_NULLPTR));
    } // retranslateUi
