...
public:
    ...
    {
        Dialog->setWindowTitle(QApplication::translate("Dialog", "Select XPlane Dataref", Q_NULLPTR));
        ...
        label_3->setText(QApplication::translate("Dialog", "Dataref:", Q_NULLPTR));
        ...
        ___qtablewidgetitem1->setText(QApplication::translate("Dialog", "Dataref", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = datarefTableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("Dialog", "Type", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = datarefTableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("Dialog", "Writable", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = datarefTableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("Dialog", "Unit", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem5 = datarefTableWidget->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("Dialog", "Description", Q_NULLPTR));
    } // retranslateUi
