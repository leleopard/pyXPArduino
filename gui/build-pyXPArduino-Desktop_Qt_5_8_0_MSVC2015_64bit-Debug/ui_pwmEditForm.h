...
""));
    ...
    {
        pwmEditForm->setWindowTitle(QApplication::translate("pwmEditForm", "Form", Q_NULLPTR));
        PWMoutValueLabel->setText(QApplication::translate("pwmEditForm", "TextLabel", Q_NULLPTR));
        drefInfoLabel->setText(QString());
        label_7->setText(QApplication::translate("pwmEditForm", " PWM Output Value  ", Q_NULLPTR));
        label_4->setText(QApplication::translate("pwmEditForm", "PWM Output Values:  ", Q_NULLPTR));
        ...
        label_19->setText(QApplication::translate("pwmEditForm", "ID", Q_NULLPTR));
        label_18->setText(QApplication::translate("pwmEditForm", "Arduino pin:", Q_NULLPTR));
        pushButton->setText(QApplication::translate("pwmEditForm", "Pick ...", Q_NULLPTR));
        label_3->setText(QApplication::translate("pwmEditForm", "Name", Q_NULLPTR));
        label_6->setText(QApplication::translate("pwmEditForm", " Dataref Value  ", Q_NULLPTR));
        drefValueLabel->setText(QString());
        label_5->setText(QApplication::translate("pwmEditForm", "Dataref Info", Q_NULLPTR));
        label_8->setText(QApplication::translate("pwmEditForm", "Edit PWM output", Q_NULLPTR));
        label->setText(QApplication::translate("pwmEditForm", "Dataref index", Q_NULLPTR));
        label_2->setText(QApplication::translate("pwmEditForm", "XPlane Dataref:", Q_NULLPTR));
    } // retranslateUi
