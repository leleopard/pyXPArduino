...
public:
    ...
    void setupUi(QWidget *potentiometerEditForm)
    {
        ...
        CMDS_TABLE->setHorizontalHeaderItem(0, __qtablewidgetitem);
        QTableWidgetItem *__qtablewidgetitem1 = new QTableWidgetItem();
        CMDS_TABLE->setHorizontalHeaderItem(1, __qtablewidgetitem1);
        CMDS_TABLE->setObjectName(QStringLiteral("CMDS_TABLE"));
        QSizePolicy sizePolicy1(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(CMDS_TABLE->sizePolicy().hasHeightForWidth());
        CMDS_TABLE->setSizePolicy(sizePolicy1);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/newPrefix/minusIcon.png"), QSize(), QIcon::Normal, QIcon::On);
        RMCMD_BTN->setIcon(icon1);
...
"}"));
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/newPrefix/minusIcon.png"), QSize(), QIcon::Normal, QIcon::Off);
        RMDREF_BTN->setIcon(icon3);
        ...
        DREFS_TABLE->setHorizontalHeaderItem(0, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        DREFS_TABLE->setHorizontalHeaderItem(1, __qtablewidgetitem3);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        DREFS_TABLE->setHorizontalHeaderItem(2, __qtablewidgetitem4);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        DREFS_TABLE->setHorizontalHeaderItem(3, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        DREFS_TABLE->setHorizontalHeaderItem(4, __qtablewidgetitem6);
        DREFS_TABLE->setObjectName(QStringLiteral("DREFS_TABLE"));
        sizePolicy1.setHeightForWidth(DREFS_TABLE->sizePolicy().hasHeightForWidth());
        DREFS_TABLE->setSizePolicy(sizePolicy1);
        ...
        drefsHelpText->setMinimumSize(QSize(500, 0));
    ...
    {
        potentiometerEditForm->setWindowTitle(QApplication::translate("potentiometerEditForm", "Form", nullptr));
        QTableWidgetItem *___qtablewidgetitem = CMDS_TABLE->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("potentiometerEditForm", "Command", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = CMDS_TABLE->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("potentiometerEditForm", "Send if pot value is in intervals", nullptr));
#ifndef QT_NO_TOOLTIP
        ___qtablewidgetitem1->setToolTip(QApplication::translate("potentiometerEditForm", "<html><head/><body><p>Enter intervals where the command should be sent. </p><p>For example to send the command if the pot value is between 0 and 200 or between 600 and 800, enter: </p><p><span style=\" color:#0000ff;\">(0,200), (600,800)</span></p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        CMDS_TABLE->setToolTip(QApplication::translate("potentiometerEditForm", "<html><head/><body><p>Enter intervals where the command should be sent. </p><p>For example to send the command if the pot value is between 0 and 200 or between 600 and 800, enter: </p><p><span style=\" color:#0000ff;\">(0,200), (600,800)</span></p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        label_12->setText(QApplication::translate("potentiometerEditForm", "Send XPlane Command: ", nullptr));
        ADDCMD_BTN->setText(QApplication::translate("potentiometerEditForm", "...", nullptr));
        RMCMD_BTN->setText(QApplication::translate("potentiometerEditForm", "...", nullptr));
        label->setText(QApplication::translate("potentiometerEditForm", "<html><head/><body><p>Enter intervals where the command should be sent. </p><p>For example to send the command if the pot value is between 0 and 200 or between 600 and 800, enter: </p><p><span style=\" color:#0000ff;\">[0,200], [600,800]</span></p></body></html>", nullptr));
        label_8->setText(QApplication::translate("potentiometerEditForm", "Edit potentiometer", nullptr));
        label_17->setText(QApplication::translate("potentiometerEditForm", "Value", nullptr));
        label_15->setText(QApplication::translate("potentiometerEditForm", "Command actions:", nullptr));
        label_3->setText(QApplication::translate("potentiometerEditForm", "Name", nullptr));
        label_9->setText(QApplication::translate("potentiometerEditForm", "Dataref Actions:", nullptr));
        label_18->setText(QApplication::translate("potentiometerEditForm", "Arduino pin:", nullptr));
        label_19->setText(QApplication::translate("potentiometerEditForm", "ID", nullptr));
        valueLabel->setText(QApplication::translate("potentiometerEditForm", "0", nullptr));
        label_11->setText(QApplication::translate("potentiometerEditForm", "Set Dataref: ", nullptr));
        ADDDREF_BTN->setText(QApplication::translate("potentiometerEditForm", "...", nullptr));
        RMDREF_BTN->setText(QApplication::translate("potentiometerEditForm", "...", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = DREFS_TABLE->horizontalHeaderItem(0);
        ___qtablewidgetitem2->setText(QApplication::translate("potentiometerEditForm", "Dataref", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = DREFS_TABLE->horizontalHeaderItem(1);
        ___qtablewidgetitem3->setText(QApplication::translate("potentiometerEditForm", "Index", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = DREFS_TABLE->horizontalHeaderItem(2);
        ___qtablewidgetitem4->setText(QApplication::translate("potentiometerEditForm", "Set to Value", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = DREFS_TABLE->horizontalHeaderItem(3);
        ___qtablewidgetitem5->setText(QApplication::translate("potentiometerEditForm", "Type", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = DREFS_TABLE->horizontalHeaderItem(4);
        ___qtablewidgetitem6->setText(QApplication::translate("potentiometerEditForm", "Unit", nullptr));
