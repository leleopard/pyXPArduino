...
"")
        ...
        self.splitter_3 = QtWidgets.QSplitter(self.tab_instruments)
        self.splitter_3.setGeometry(QtCore.QRect(0, 0, 1161, 621))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(20)
        ...
        self.horizontalLayout_3.addWidget(self.instrumentsTreeWidget)
        ...
        self.widget_logger = QtWidgets.QWidget(self.splitter_2)
