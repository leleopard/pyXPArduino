...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab_arduino = QtWidgets.QWidget()
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tab_arduino.sizePolicy().hasHeightForWidth())
        self.tab_arduino.setSizePolicy(sizePolicy)
        self.tab_arduino.setAccessibleName("")
        self.tab_arduino.setAccessibleDescription("")
        self.tab_arduino.setAutoFillBackground(False)
        self.tab_arduino.setObjectName("tab_arduino")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tab_arduino)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.splitter = QtWidgets.QSplitter(self.tab_arduino)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/newPrefix/ardIcon2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tab_arduino, icon1, "")
        self.tab_instrumentpanels = QtWidgets.QWidget()
        self.tab_instrumentpanels.setObjectName("tab_instrumentpanels")
        self.tabWidget.addTab(self.tab_instrumentpanels, "")
        self.tab_instruments = QtWidgets.QWidget()
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tab_instruments.sizePolicy().hasHeightForWidth())
        self.tab_instruments.setSizePolicy(sizePolicy)
        self.tab_instruments.setObjectName("tab_instruments")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.tab_instruments)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.splitter_2 = QtWidgets.QSplitter(self.tab_instruments)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(20)
        ...
        self.instrumentsTreeWidget = QtWidgets.QTreeWidget(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.instrumentsTreeWidget.sizePolicy().hasHeightForWidth())
        self.instrumentsTreeWidget.setSizePolicy(sizePolicy)
        self.instrumentsTreeWidget.setColumnCount(1)
        self.instrumentsTreeWidget.setObjectName("instrumentsTreeWidget")
        self.instrumentsTreeWidget.headerItem().setText(0, "Name")
        self.horizontalLayout.addWidget(self.instrumentsTreeWidget)
        self.instrumentEditPane = QtWidgets.QWidget(self.splitter_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(3)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.instrumentEditPane.sizePolicy().hasHeightForWidth())
        self.instrumentEditPane.setSizePolicy(sizePolicy)
        self.instrumentEditPane.setObjectName("instrumentEditPane")
        self.horizontalLayout_instrumentEditPane = QtWidgets.QHBoxLayout(self.instrumentEditPane)
        self.horizontalLayout_instrumentEditPane.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_instrumentEditPane.setObjectName("horizontalLayout_instrumentEditPane")
        self.verticalLayout_4.addWidget(self.splitter_2)
        self.tabWidget.addTab(self.tab_instruments, "")
        self.verticalLayout.addWidget(self.tabWidget)
        self.widget_logger = QtWidgets.QWidget(self.centralwidget)
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.widget_logger)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.label_11 = QtWidgets.QLabel(self.widget_logger)
...
"padding: 3px")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/newPrefix/quit.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.actionAdd_Arduino.setIcon(icon3)
        self.actionAdd_Arduino.setObjectName("actionAdd_Arduino")
        self.actionUDP_Settings = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/newPrefix/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUDP_Settings.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/newPrefix/save_active.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionSave.setIcon(icon5)
        self.actionSave.setObjectName("actionSave")
        self.actionOpen_Arduino_config_file = QtWidgets.QAction(MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/newPrefix/open.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_Arduino_config_file.setIcon(icon6)
        self.actionOpen_Arduino_config_file.setObjectName("actionOpen_Arduino_config_file")
        self.actionCreate_new_Arduino_config_file = QtWidgets.QAction(MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/newPrefix/file_plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCreate_new_Arduino_config_file.setIcon(icon7)
        self.actionCreate_new_Arduino_config_file.setObjectName("actionCreate_new_Arduino_config_file")
        self.actionRun_Instrument = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/newPrefix/outputIcon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRun_Instrument.setIcon(icon8)
        self.actionRun_Instrument.setObjectName("actionRun_Instrument")
        self.menuFile.addAction(self.actionCreate_new_Arduino_config_file)
        self.menuFile.addAction(self.actionOpen_Arduino_config_file)
        ...
        self.toolBar.addAction(self.actionCreate_new_Arduino_config_file)
        self.toolBar.addAction(self.actionOpen_Arduino_config_file)
        self.toolBar.addAction(self.actionAdd_Arduino)
        ...
        self.actionOpen_Arduino_config_file.triggered.connect(MainWindow.openArduinoConfigFile)
        self.actionCreate_new_Arduino_config_file.triggered.connect(MainWindow.createArduinoConfigFile)
        ...
        self.instrumentsTreeWidget.itemSelectionChanged.connect(MainWindow.instrumentTreeSelectionChanged)
        self.actionRun_Instrument.triggered.connect(MainWindow.instrumentRun)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_arduino), _translate("MainWindow", "Arduinos"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_instrumentpanels), _translate("MainWindow", "Instrument Panels"))
        ...
        self.menuX_Plane.setTitle(_translate("MainWindow", "X Plane Settings"))
        ...
        self.actionOpen_Arduino_config_file.setText(_translate("MainWindow", "Open Arduino config file..."))
        self.actionCreate_new_Arduino_config_file.setText(_translate("MainWindow", "Create new Arduino config file"))
        self.actionRun_Instrument.setText(_translate("MainWindow", "Run Instrument"))
        self.actionRun_Instrument.setToolTip(_translate("MainWindow", "Test Instrument"))
import resources_rc
